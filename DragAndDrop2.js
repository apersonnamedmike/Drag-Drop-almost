...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/DMH_35_00_digital_display_numbers_SFS_dashes.png?1461346009352", id:"DMH_35_00_digital_display_numbers_SFS_dashes"},
		{src:"images/DMH_35_02_roasted_chicken.png?1461346009352", id:"DMH_35_02_roasted_chicken"},
		{src:"images/DMH_35_thermistor_alone.png?1461346009352", id:"DMH_35_thermistor_alone"},
		{src:"images/DMH_35_thermistor_buttons_.png?1461346009352", id:"DMH_35_thermistor_buttons_"}
	]
};
...
(lib.drag = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FFFF").s().p("AhgBzIAAjlIDBAAIAADlg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-9.7,-11.5,19.5,23.1);
...
(lib.CorrectDropZone = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FFFF").s().p("A1eXbMAAAgu2MAq9AAAMAAAAu2g");
	this.shape.setTransform(137.5,150);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Temp Labels
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(115.4,73.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(106.2,71.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgZAqIAAhRIAUAAIAAAMQAFgIACgDQAEgDAGAAQAHAAAIAEIgHATQgGgDgFAAQgFAAgDACQgBADgCAHQgCAGAAATIAAAag");
	this.shape_2.setTransform(99.3,71.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgcAuQgLgLAAgVQAAgTAKgLQAKgLAPAAQAMAAAKALIAAgpIAWAAIAABxIgVAAIAAgMQgFAHgGADQgHAEgFAAQgPAAgJgMgAgLgEQgFAEAAAMQAAAOADAGQAFAIAIAAQAIAAAFgGQAFgHAAgMQAAgPgFgEQgFgGgIAAQgGAAgFAGg");
	this.shape_3.setTransform(90.5,70.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AguAVIA5g5IAOAPIgIAIQAJgCAFABQAFABAEAEQAFAFACAGIgSAIQgCgGgDgDQgDgBgEgBQgEgBgGACQgHADgNAPIgSASg");
	this.shape_4.setTransform(24.4,4.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgIAqQgLgCgJgKQgQgPADgPQACgOANgNQAOgOAOgBQAQAAAMALQANANgBAQQgCAPgRARIglglQgHAHAAAGQAAAHAFAFQAEAEAEABQAFAAADgDIANASQgIAFgHAAIgGgBgAgEgQIAVAVQAGgFAAgGQAAgHgEgFQgFgFgHAAQgHABgEAGg");
	this.shape_5.setTransform(18.6,0);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("");
	this.shape_6.setTransform(11.4,-5.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(4.5,-12.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("");
	this.shape_8.setTransform(-1.6,-19.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AguAVIA5g4IAOAOIgIAIQAJgCAFABQAFABAEAEQAFAFACAGIgSAIQgCgGgDgDQgEgCgDAAQgFgBgFACQgHAEgMAOIgSASg");
	this.shape_9.setTransform(-6.4,-26.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AggAkIAJgIQgJABgHgCQgIgDgFgFQgKgKACgNQAAgQAPgOQAPgPAOgBQAPgBAJALQAKAKgBAPIAdgdIAQAQIhPBPgAgLgcQgIAAgJAJQgKAJgBAHQgCAIAGAGQAGAGAIgBQAIgBAJgJQAIgIABgIQABgIgGgGQgDgEgGAAIgCAAg");
	this.shape_10.setTransform(-10.8,-30.6);
	...
	this.drag.setTransform(89.4,87.5);
	this.drag.alpha = 0.27;

	this.timeline.addTween(cjs.Tween.get(this.drag).wait(30));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-99,-99,221.6,198);


// stage content:
(lib.DragAndDrop2 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{Scene2:0,"Drag Func":16});
	...
	this.frame_16 = function() {
		...
		//====== Current Fix: Set these to the instance names of the corresponding Drop Areas ======
		var tip = this.thermometer.drag;
		var right = this.targetRight; //set this to correct spot
		var wrong = this.targetWrong; //set this to incorrect spot
		
		
		
		
		//============= Get this to set automatically from the vars, right and wrong ===============
		//--------------(x, y, w, h)----------------------------------------------------------------
		right.setBounds(right.x, right.y, right.width, right.height);
		wrong.setBounds(wrong.x, wrong.y, wrong.width, wrong.height);
		tip.setBounds(tip.x, tip.y, tip.width, tip.height);
		//==========================================================================================
	...
	this.thermometer.setTransform(808.4,454.1);
	...
	this.targetRight.setTransform(343.5,235.7,0.536,0.443,0,0,0,275,150);
	...
	this.targetWrong.setTransform(551.9,288.7,0.891,0.578,0,0,0,413,215);
	...
	// Layer 17
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgdAuQgKgLAAgVQAAgTAKgLQAKgLAPAAQAMAAAKALIAAgpIAWAAIAABxIgUAAIAAgMQgGAHgHADQgGAEgFAAQgOAAgLgMgAgLgEQgGAEAAAMQAAAOAEAGQAGAIAHAAQAIAAAFgGQAFgHAAgMQAAgPgFgEQgFgGgIAAQgGAAgFAGg");
	this.shape.setTransform(516.1,385.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(507,386.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AguA5IAAhxIAuAAIASABQAHABAFAEQAFAEADAGQAEAGAAAHQAAAIgFAHQgEAHgHADQAKACAGAGQAGAIgBAKQAAAHgDAIQgEAHgGAFQgGAEgKABQgFABgVAAgAgXAlIAWAAIANAAQAFgBADgEQAEgDAAgHQAAgFgCgDQgDgEgFgCQgEgBgPAAIgSAAgAgXgKIAPAAIAPgBQAGAAADgEQAEgDgBgGQAAgFgCgDQgDgEgGAAIgSgBIgNAAg");
	this.shape_2.setTransform(496.9,385.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgcAuQgLgLAAgVQAAgTAKgLQAKgLAPAAQAMAAAKALIAAgpIAWAAIAABxIgUAAIAAgMQgGAHgHADQgGAEgFAAQgOAAgKgMgAgLgEQgGAEAAAMQAAAOAEAGQAGAIAHAAQAHAAAGgGQAFgHAAgMQAAgPgFgEQgFgGgIAAQgGAAgFAGg");
	this.shape_3.setTransform(269.9,286.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgUAmQgLgGgFgJQgFgLAAgMQAAgLAFgKQAFgKAKgGQAKgFALAAQASAAAMANQAMAMAAARQAAASgMANQgMAMgSAAQgKAAgKgFgAgNgSQgGAHAAALQAAAMAGAGQAGAHAHAAQAIAAAGgHQAGgGAAgMQAAgLgGgHQgGgGgIAAQgHAAgGAGg");
	this.shape_4.setTransform(260.3,287.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgUAmQgLgGgFgJQgFgLAAgMQAAgLAFgKQAFgKAKgGQAKgFALAAQASAAAMANQAMAMAAARQAAASgMANQgMAMgSAAQgKAAgKgFgAgNgSQgGAHAAALQAAAMAGAGQAGAHAHAAQAIAAAGgHQAGgGAAgMQAAgLgGgHQgGgGgIAAQgHAAgGAGg");
	this.shape_5.setTransform(250.6,287.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AgZAzQgOgHgGgOQgHgOAAgQQAAgRAHgOQAIgOAOgHQALgGAPAAQAVAAAMAJQAMAJAEAQIgXAEQgDgIgGgFQgHgFgKAAQgNAAgJAKQgJAJAAATQAAATAJAKQAJAKANAAQAHAAAHgDQAHgDAGgEIAAgOIgbAAIAAgSIAyAAIAAAsQgHAHgOAFQgOAGgOAAQgQAAgNgIg");
	this.shape_6.setTransform(239.3,286.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},15).wait(5));
	...
	// White Base
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("EhMjAo3MAAAhRsMCZHAAAMAAABRsg");
	this.shape_7.setTransform(490,311.5);

	this.timeline.addTween(cjs.Tween.get(this.shape_7).wait(20));
